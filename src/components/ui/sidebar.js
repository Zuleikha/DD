...
const SidebarInput = React.forwardRef(({ className, id, name, ...props }, ref) => {
    return (_jsx(Input, { ref: ref, "data-sidebar": "input", id: id, name: name, className: cn("h-8 w-full bg-white shadow-none focus-visible:ring-2 focus-visible:ring-sidebar-ring dark:bg-zinc-950", className), ...props }));
});
