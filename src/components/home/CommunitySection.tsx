      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:transform hover:scale-105">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">Connect with other dog owners across Ireland. Share tips, ask questions, and join the conversation.</p>
              <a 
                href="/forum" 
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Join thousands of dog owners across Ireland who are already part of our growing community. Share experiences, find resources, and connect with fellow dog lovers.
          </p>
          <a 
            href="/register" 
            className="inline-block px-8 py-3 bg-[#2C3E50] text-white font-medium rounded-md hover:bg-[#1A2530] transition-colors duration-300"
          >
            Create Free Account
          </a>
        </div>
