      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex space-x-6">
            <a href="/vets" className="text-gray-700 hover:text-[#4A90E2] font-medium">
            ...
            <a href="/parks" className="text-gray-700 hover:text-[#4A90E2] font-medium">
              <span className="flex items-center">
                <svg className="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/nutrition" className="text-gray-700 hover:text-[#4A90E2] font-medium">
              <span className="flex items-center">
                <svg className="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/training" className="text-gray-700 hover:text-[#4A90E2] font-medium">
              <span className="flex items-center">
                <svg className="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/grooming" className="text-gray-700 hover:text-[#4A90E2] font-medium">
              <span className="flex items-center">
                <svg className="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/places" className="text-gray-700 hover:text-[#4A90E2] font-medium">
              <span className="flex items-center">
                <svg className="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/community" className="text-gray-700 hover:text-[#4A90E2] font-medium">
              <span className="flex items-center">
                <svg className="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
